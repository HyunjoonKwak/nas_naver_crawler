      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center">
            {/* Logo & Title */}
            <div className="mb-6">
              <div className="inline-block p-4 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-3xl shadow-2xl mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="flex flex-col items-center text-center p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-1">자동 크롤링</h3>
                <p className="text-gray-600 dark:text-gray-400 text-xs">
                  관심 단지 매물 정보를<br/>정기적으로 자동 수집
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-1">실시간 분석</h3>
                <p className="text-gray-600 dark:text-gray-400 text-xs">
                  매매·전세·월세 매물의<br/>통계와 트렌드 분석
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-1">스마트 알림</h3>
                <p className="text-gray-600 dark:text-gray-400 text-xs">
                  조건 맞는 매물 등록 시<br/>Discord로 즉시 알림
                </p>
              </div>
            </div>
          </div>
